//
//  MeanLessViewController3.swift
//  Test3
//
//  Created by 차요셉 on 30/12/2019.
...
class MeanLessViewController3: UIViewController, SFSpeechRecognizerDelegate, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    @IBAction func VideoClick(_ sender: Any) {
        guard let path = Bundle.main.path(forResource: "이이", ofType:"MOV") else {
