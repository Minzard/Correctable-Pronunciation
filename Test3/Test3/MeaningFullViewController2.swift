//
//  MeaningFullViewController2.swift
//  Test3
//
...
class MeaningFullViewController2: UIViewController {
...
//                            self.thirdView.text = String(DSTT[DSTT.index(DSTT.startIndex, offsetBy: 2)])
                            ...
                            self.sixthView.text=String(DSTT[DSTT.index(DSTT.startIndex, offsetBy: 4)])
