//
//  MeaningFullViewController1.swift
//  Test3
//
//  Created by 차요셉 on 02/01/2020.
...
class MeaningFullViewController1: UIViewController, SFSpeechRecognizerDelegate, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
...
//
  ...
  @IBAction func VideoClick(_ sender: Any) {
        guard let path = Bundle.main.path(forResource: "사과", ofType:"MOV") else {
